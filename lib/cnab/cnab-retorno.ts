// Parser do arquivo RETORNO CNAB 240 (padrão FEBRABAN, comum aos bancos suportados).
...
export function parseRetornoCnab240(conteudo: string): { itens: RetornoItem[]; ehRetorno: boolean } {
